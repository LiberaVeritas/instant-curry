...
```
cd existing_repo
git remote add origin https://gitlab.cs.mcgill.ca/comp-302/instant-curry.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cs.mcgill.ca/comp-302/instant-curry/-/settings/integrations)
